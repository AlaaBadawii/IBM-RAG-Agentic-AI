...
LINKEDIN_CONTRACT = (
    ...
    "Voice: first person when speaking as the persona; confident but not "
    "exaggerated; professional but conversational; specific rather than "
    "vague; human rather than corporate. No press-release, README, academic, "
    "or motivational-poster language; no fake enthusiasm; no thought-leader "
    "posturing.\n"
